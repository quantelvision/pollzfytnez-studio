...
export function HowToStart() {
  return (
    <Section id="start" className="bg-accent-tint">
      ...
      <ol className="mt-14 grid gap-y-10 sm:grid-cols-3 sm:gap-x-8">
        {site.steps.map((step, index) => (
          <li key={step.id} className="relative flex gap-5 sm:block">
            ...
            <span className="relative z-10 flex size-12 shrink-0 items-center justify-center rounded-button border-2 border-accent bg-surface type-h3 text-accent">
              {index + 1}
            </span>

            <div className="pb-2 sm:mt-6 sm:pb-0">
